...
Однако, пройдя курс лечения, удалось победить одного из них
Создадим слайс с венерическими заболеваниями, и удалим из него один элемента
